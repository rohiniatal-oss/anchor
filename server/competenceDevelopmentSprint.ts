...
import {
  ...
  completionContractForSprintContributor,
  type CompletionContract,
} from "@shared/completionContracts";

export type { CompletionContract } from "@shared/completionContracts";
  ...
  return [
    {
      ...
      createsLiveTask: false,
      completionContract: COMPLETION_CONTRACTS.capture,
    },
    {
      ...
      sourceExperienceTitle: experience.title,
      createsLiveTask: false,
      completionContract: completionContractForSprintContributor(experience.contributor),
    },
    {
      ...
      sourceExperienceTitle: experience.title,
      createsLiveTask: false,
      completionContract: COMPLETION_CONTRACTS.rubricReflection,
    },
  ];
}
