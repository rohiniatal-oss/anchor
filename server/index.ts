...
import { registerSignalCaptureRoutes } from "./signalCapture";
...
(async () => {
  ...
  // exploration, and signal routes sit upstream of generic CRUD because they
  // create the discovery and planning context.
  ...
  registerSignalCaptureRoutes(app);
