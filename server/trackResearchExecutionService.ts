...
export type ExecutionBlueprintResult = Awaited<ReturnType<typeof computeExecutionBlueprint>>;
...
export function executionBlueprintResultError(
  result: Exclude<ExecutionBlueprintResult, null>,
): string {
